-- =============================================================
-- Seed blog articles (phase 2)
-- =============================================================
-- How to use:
--   1. Go to your Neon project dashboard
--   2. Open the SQL Editor (https://console.neon.tech)
--   3. Paste this entire file
--   4. Run the query
--
-- The upsert (ON CONFLICT) makes it safe to run multiple times.
-- =============================================================

INSERT INTO "NewsArticle" (id, title, slug, excerpt, content, "titleEn", "excerptEn", "contentEn", category, "authorId", "isPublished", "publishedAt", "createdAt", "updatedAt")
VALUES
  (
    gen_random_uuid(),
    'Mejores páginas para leer manga en español en 2026',
    'mejores-paginas-leer-manga-espanol',
    '¿Buscas las mejores páginas para leer manga en español? Te presentamos las plataformas más completas con catálogo en español, actualizaciones diarias y funciones exclusivas como gamificación.',
    $$<p>Encontrar páginas para leer manga en español de calidad es más fácil que nunca. La demanda de contenido en español ha crecido enormemente, y las plataformas responden cada vez mejor a esta necesidad. Pero no todas las opciones son iguales.</p>
...
<p>Además, MangaAura actualiza su catálogo semanalmente y permite a los creadores publicar sus obras directamente, manteniendo el 100% de sus derechos. Una plataforma que cuida tanto a lectores como a creadores.</p>$$,
    'Best websites to read manga in Spanish in 2026',
    'Looking for the best websites to read manga in Spanish? We present the most complete platforms with Spanish catalog, daily updates and exclusive features like gamification.',
    $$<p>Finding quality websites to read manga in Spanish is easier than ever. Demand for Spanish content has grown enormously, and platforms are responding better than ever. But not all options are equal.</p>
...
<p>Additionally, MangaAura updates its catalog weekly and allows creators to publish their works directly, keeping 100% of their rights. A platform that cares for both readers and creators.</p>$$,
    'platform',
    '7e054872-aa97-4f0e-a354-ed7318a51c1f',
    true,
    NOW(),
    NOW(),
    NOW()
  ...
  (
    gen_random_uuid(),
    'Mejores aplicaciones para dibujar manga en PC y tablet',
    'aplicaciones-dibujar-manga-pc-tablet',
    '¿Qué aplicación usar para dibujar manga? Comparamos Clip Studio Paint, Procreate, Krita, MediBang y otras. Encuentra la herramienta perfecta para tu estilo y presupuesto.',
    $$<p>Crear manga digital requiere las herramientas adecuadas. Afortunadamente, hay aplicaciones para dibujar manga en PC y tablet para todos los niveles y presupuestos. Desde software profesional gratuito hasta suites completas de pago.</p>
...
<p>¿Usas varias aplicaciones? No hay problema. MangaAura acepta los formatos más comunes (PNG, JPG, PDF) y optimiza automáticamente tus páginas para una lectura perfecta en cualquier dispositivo.</p>$$,
    'Best apps to draw manga on PC and tablet',
    'Which app should you use to draw manga? We compare Clip Studio Paint, Procreate, Krita, MediBang and more. Find the perfect tool for your style and budget.',
    $$<p>Creating digital manga requires the right tools. Fortunately, there are apps to draw manga on PC and tablet for every level and budget. From free professional software to complete paid suites.</p>
...
<p>Once your chapters are ready, the next step is publishing. MangaAura offers an intuitive publishing system where you can upload your pages with drag and drop. Creators keep 100% of their rights and receive direct financial support from readers through crowdfunding with Aura. It''s the ideal platform for creators using any of these apps to draw manga.</p>$$,
  ...
  (
    gen_random_uuid(),
    'Cómo ganar dinero dibujando manga en 2026',
    'como-ganar-dinero-dibujando-manga-2026',
    '¿Se puede vivir del manga en 2026? Descubre las estrategias reales para monetizar tu obra: crowdfunding, plataformas digitales, comisiones y más. Incluye casos de éxito en MangaAura.',
    $$<p>La pregunta que todo mangaka se hace: ¿cómo ganar dinero dibujando manga en 2026? La buena noticia es que nunca ha habido tantas vías de monetización. La industria del manga digital está en plena expansión y los creadores tienen más oportunidades que nunca.</p>
...
<p>El camino no es fácil, pero con constancia y las herramientas adecuadas, vivir del manga es más alcanzable que nunca. MangaAura está construyendo la infraestructura para que los creadores puedan centrarse en lo que mejor saben hacer: crear.</p>$$,
    'How to make money drawing manga in 2026',
    'Can you make a living from manga in 2026? Discover real strategies to monetize your work: crowdfunding, digital platforms, commissions and more. Includes MangaAura success stories.',
    $$<p>The question every mangaka asks: how to make money drawing manga in 2026? The good news is there have never been so many monetization avenues. The digital manga industry is booming and creators have more opportunities than ever.</p>
...
<p>The road isn''t easy, but with persistence and the right tools, making a living from manga is more achievable than ever. MangaAura is building the infrastructure so creators can focus on what they do best: create.</p>$$,
  ...
  (
    gen_random_uuid(),
    'Mejores plataformas para publicar manga online',
    'mejores-plataformas-publicar-manga-online',
    '¿Quieres publicar tu manga online? Comparamos MangaAura, Webtoon Canvas, Tapas y MangaPlus Creators. Analizamos derechos, monetización, alcance y facilidad de uso para cada plataforma.',
    $$<p>Si has creado tu propio manga, el siguiente paso es elegir dónde publicarlo. Las plataformas para publicar manga online han crecido enormemente, ofreciendo opciones para todo tipo de creadores. Pero no todas son iguales en términos de derechos, monetización y alcance.</p>
...
<p>Si tu prioridad es la monetización y el control, MangaAura es la mejor plataforma para publicar manga online. Si buscas audiencia masiva, Webtoon Canvas tiene más usuarios pero menos control. Para creadores que quieren ser descubiertos por editoriales, MangaPlus Creators es una buena opción. Y Tapas ofrece un equilibrio entre ambos mundos.</p>$$,
    'Best platforms to publish manga online',
    'Want to publish your manga online? We compare MangaAura, Webtoon Canvas, Tapas and MangaPlus Creators. We analyze rights, monetization, reach and ease of use for each platform.',
    $$<p>If you''ve created your own manga, the next step is choosing where to publish it. Platforms to publish manga online have grown enormously, offering options for all types of creators. But they are not all equal in terms of rights, monetization and reach.</p>
...
<p>If your priority is monetization and control, MangaAura is the best platform to publish manga online. If you seek massive audience, Webtoon Canvas has more users but less control. For creators wanting to be discovered by publishers, MangaPlus Creators is a good option. And Tapas offers a balance between both worlds.</p>$$,
  ...
  (
    gen_random_uuid(),
    'Qué es el crowdfunding de manga y cómo funciona',
    'crowdfunding-manga-como-funciona',
    'Descubre cómo el crowdfunding de manga está cambiando las reglas del juego. Explicamos cómo funciona, por qué es beneficioso para creadores y cómo MangaAura lo implementa con su moneda Aura.',
    $$<p>El crowdfunding de manga es un modelo de financiación colectiva que permite a los lectores apoyar económicamente a sus creadores favoritos. A diferencia del modelo tradicional donde una editorial decide qué series publicar, aquí son los lectores quienes deciden qué obras merecen continuar.</p>
...
<p>El crowdfunding de manga no es el futuro, es el presente. Y plataformas como MangaAura están demostrando que este modelo funciona tanto para creadores establecidos como para nuevos talentos.</p>$$,
    'What is manga crowdfunding and how does it work',
    'Discover how manga crowdfunding is changing the game. We explain how it works, why it benefits creators, and how MangaAura implements it with its Aura currency.',
    $$<p>Manga crowdfunding is a collective financing model that allows readers to financially support their favorite creators. Unlike the traditional model where a publisher decides which series to publish, here readers decide which works deserve to continue.</p>
...
<p>Manga crowdfunding isn''t the future, it''s the present. And platforms like MangaAura are proving this model works for both established creators and new talent.</p>$$,
  ...
  (
    gen_random_uuid(),
    'Las mejores herramientas de inteligencia artificial para crear manga en 2026',
    'herramientas-ia-crear-manga',
    'La IA está transformando la creación de manga. Descubre las herramientas de inteligencia artificial para crear manga más potentes: generación de bocetos, colorización automática, fondos y más.',
    $$<p>La inteligencia artificial está revolucionando la forma de crear manga. Desde la generación de bocetos iniciales hasta la colorización automática, las herramientas de inteligencia artificial para crear manga están haciendo que el proceso sea más rápido y accesible que nunca.</p>
...
<p>La IA no reemplazará al mangaka, pero los creadores que sepan aprovechar estas herramientas tendrán una ventaja enorme. El futuro del manga es híbrido: talento humano potenciado por inteligencia artificial. Y plataformas como MangaAura están en la vanguardia de esta transformación.</p>$$,
    'Best artificial intelligence tools to create manga in 2026',
    'AI is transforming manga creation. Discover the most powerful artificial intelligence tools to create manga: sketch generation, automatic coloring, backgrounds and more.',
    $$<p>Artificial intelligence is revolutionizing the way manga is created. From initial sketch generation to automatic coloring, artificial intelligence tools to create manga are making the process faster and more accessible than ever.</p>
...
<p>AI won''t replace mangaka, but creators who know how to leverage these tools will have a huge advantage. The future of manga is hybrid: human talent powered by artificial intelligence. And platforms like MangaAura are at the forefront of this transformation.</p>$$,
  ...
  (
    gen_random_uuid(),
    'Sistema de niveles y logros en apps de lectura de manga',
    'niveles-logros-apps-lectura',
    '¿Cómo funciona el sistema de niveles y logros en las apps de lectura de manga? Explicamos los beneficios de la gamificación y cómo MangaAura ha creado el sistema más completo del mercado.',
    $$<p>El sistema de niveles y logros en apps de lectura de manga ha transformado la experiencia de leer. Lo que antes era una actividad solitaria ahora es una aventura compartida donde cada capítulo cuenta, cada racha importa y cada logro desbloquea nuevas posibilidades.</p>
...
<p>La gamificación no es solo un adorno: los usuarios de MangaAura que participan en el sistema de niveles leen un 40% más que los que no lo hacen. Es una prueba de que un buen sistema de niveles y logros en apps de lectura de manga mejora genuinamente la experiencia y el engagement.</p>$$,
    'Level and achievement system in manga reading apps',
    'How does the level and achievement system work in manga reading apps? We explain the benefits of gamification and how MangaAura created the most complete system on the market.',
    $$<p>The level and achievement system in manga reading apps has transformed the reading experience. What was once a solitary activity is now a shared adventure where every chapter counts, every streak matters, and every achievement unlocks new possibilities.</p>
...
<p>Gamification isn''t just decoration: MangaAura users who participate in the level system read 40% more than those who don''t. It''s proof that a good level and achievement system in manga reading apps genuinely improves both experience and engagement.</p>$$,
  ...
  (
    gen_random_uuid(),
    'Leer manga con amigos: mejores plataformas sociales de lectura',
    'leer-manga-con-amigos-plataformas-sociales',
    'Descubre las mejores plataformas para leer manga con amigos. La lectura social está revolucionando el manga: clanes, rankings compartidos, clubs de lectura y más. MangaAura lidera esta tendencia.',
    $$<p>Leer manga con amigos es una experiencia completamente diferente a hacerlo solo. Compartir teorías, reaccionar a los giros argumentales y competir por ver quién lee más convierte la lectura en una actividad social. Y cada vez más plataformas están apostando por esta tendencia.</p>
...
<p>Si aún no has probado a leer manga con amigos, MangaAura es el lugar perfecto para empezar. Crea un clan, invita a tus amigos y descubre una nueva forma de disfrutar del manga.</p>$$,
    'Read manga with friends: best social reading platforms',
    'Discover the best platforms to read manga with friends. Social reading is revolutionizing manga: clans, shared rankings, reading clubs and more. MangaAura leads this trend.',
    $$<p>Reading manga with friends is a completely different experience from reading alone. Sharing theories, reacting to plot twists, and competing to see who reads more turns reading into a social activity. And more platforms are betting on this trend.</p>
...
<p>If you haven''t tried reading manga with friends yet, MangaAura is the perfect place to start. Create a clan, invite your friends, and discover a new way to enjoy manga.</p>$$,
  ...
  (
    gen_random_uuid(),
    'Cómo funciona la moneda virtual Aura en plataformas de lectura',
    'moneda-virtual-aura-plataformas-lectura',
    'Explicamos cómo funciona la moneda virtual Aura de MangaAura: cómo se gana, cómo se usa y cómo está transformando la relación entre lectores y creadores en las plataformas de lectura de manga.',
    $$<p>La moneda virtual Aura es el corazón del ecosistema económico de MangaAura. Es mucho más que una moneda dentro de la plataforma: es un puente directo entre lectores y creadores que está redefiniendo cómo se financia y consume el manga digital.</p>
...
<p>MangaAura ha creado un círculo virtuoso: los lectores leen más, ganan Aura, apoyan a creadores, los creadores producen más contenido, y eso atrae a más lectores. La moneda virtual Aura no es solo una característica más de la plataforma — es el motor que impulsa todo el ecosistema.</p>$$,
    'How the Aura virtual currency works on reading platforms',
    'We explain how MangaAura''s Aura virtual currency works: how it''s earned, how it''s used, and how it''s transforming the relationship between readers and creators on manga reading platforms.',
    $$<p>The Aura virtual currency is the heart of MangaAura''s economic ecosystem. It''s much more than an in-platform currency: it''s a direct bridge between readers and creators that''s redefining how digital manga is financed and consumed.</p>
...
<p>MangaAura has created a virtuous circle: readers read more, earn Aura, support creators, creators produce more content, and that attracts more readers. Aura isn''t just another platform feature — it''s the engine driving the entire ecosystem.</p>$$,
  ...
  (
    gen_random_uuid(),
    'Manga gratis vs de pago: qué opciones hay en 2026',
    'manga-gratis-vs-pago-opciones-2026',
    'Comparamos las opciones de manga gratis y de pago en 2026. ¿Merece la pena pagar por plataformas como MangaAura? Analizamos ventajas, desventajas y cómo elegir según tu presupuesto y hábitos de lectura.',
    $$<p>Una de las preguntas más frecuentes entre los lectores de manga es: ¿manga gratis o de pago? En 2026 las opciones se han multiplicado, ofreciendo alternativas para todos los bolsillos. Pero cada modelo tiene sus ventajas y sus limitaciones.</p>
...
<p>En 2026, no tienes por qué elegir solo una opción. Combina plataformas gratuitas para series populares y usa MangaAura para descubrir y apoyar nuevos talentos. Lo importante es que siempre leas de forma legal para que los creadores sigan produciendo el contenido que tanto amas.</p>$$,
    'Free vs paid manga: what options are there in 2026',
    'We compare free and paid manga options in 2026. Is it worth paying for platforms like MangaAura? We analyze pros, cons, and how to choose based on your budget and reading habits.',
    $$<p>One of the most frequent questions among manga readers is: free or paid manga? In 2026, options have multiplied, offering alternatives for every budget. But each model has its advantages and limitations.</p>
