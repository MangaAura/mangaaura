...
export default function CommunityError({ error, reset }: { error: Error; reset: () => void }) {
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] px-4 text-center">
      ...
      <h2 className="text-xl font-bold text-[var(--text-primary)] mb-2">Error en la comunidad</h2>
      <p className="text-[var(--text-secondary)] mb-6 max-w-md">
        {error.message || 'Ocurrió un error al cargar la comunidad. Intenta de nuevo.'}
      </p>
      <button
        onClick={reset}
