    ...
    <div className="min-h-screen flex items-center justify-center bg-[var(--surface)] px-4">
      <div className="max-w-md w-full text-center">
        ...
        <h1 className="text-2xl font-bold text-[var(--text-primary)] mb-2">
          Error al cargar el clan
        </h1>
        <p className="text-[var(--text-secondary)] mb-6">
          No se pudo cargar la información del clan. Puede que no exista o haya sido eliminado.
        </p>
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          ...
          <Button variant="outline" asChild>
            <Link href="/community/clans">Ver todos los clanes</Link>
          </Button>
        </div>
      </div>
    </div>
