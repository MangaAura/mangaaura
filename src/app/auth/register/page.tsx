      ...
      <div className="flex-1 flex items-center justify-center p-6">
        <div className="w-full max-w-md [animation:fadeSlideUp_0.5s_cubic-bezier(0.16,1,0.3,1)]">
          <div className="text-center mb-8 [animation:fadeSlideUp_0.5s_cubic-bezier(0.16,1,0.3,1)_0.1s_both]">
            <h1 className="text-[2rem] font-bold leading-[2.5rem] tracking-[-0.02em] mb-2 text-[var(--text-primary)]">{t('auth.registerTitle')}</h1>
            <p className="text-[var(--text-primary)]/70">{t('auth.registerSubtitle')}</p>
          </div>
