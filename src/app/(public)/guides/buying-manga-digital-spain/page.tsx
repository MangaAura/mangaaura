...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    ...withHreflang('/guides/buying-manga-digital-spain'),
  };
}
  ...
  return (
    <>
      <WebPageStructuredData
        ...
        url="/guides/buying-manga-digital-spain"
      ...
      <BreadcrumbStructuredData
        items={[
          ...
          { name: 'Buying manga digital Spain', item: '/guides/buying-manga-digital-spain' },
        ]}
      />
      <HowToStructuredData
