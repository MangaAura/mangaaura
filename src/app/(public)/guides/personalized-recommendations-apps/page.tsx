...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    ...withHreflang('/guides/personalized-recommendations-apps'),
  };
}
  ...
  return (
    <>
      <WebPageStructuredData
        ...
        url="/guides/personalized-recommendations-apps"
      ...
      <BreadcrumbStructuredData
        items={[
          ...
          { name: 'Personalized recommendations apps', item: '/guides/personalized-recommendations-apps' },
        ]}
      />
      <FAQPageStructuredData items={faqItems} />
      <Container className="py-12">
        <nav className="mb-8">
          <Link href="/guides" className="text-sm text-fg-secondary hover:text-primary transition-colors">
            ← Volver a guías
          </Link>
        </nav>
        ...
        <article>
          ...
          <div className="space-y-6">
            <div className="border border-border rounded-xl p-5">
              ...
              <Link href="/search-ai" className="text-primary text-sm font-semibold mt-2 inline-block hover:underline">
          ...
          <ul className="list-disc pl-5 space-y-2 text-fg-secondary">
            <li>Usa la <Link href="/search-ai" className="text-primary hover:underline">búsqueda inteligente de MangaAura</Link> para encontrar series por描述, estado y popularidad.</li>
