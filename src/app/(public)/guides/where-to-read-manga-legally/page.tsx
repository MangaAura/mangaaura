...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    ...withHreflang('/guides/where-to-read-manga-legally'),
  };
}
  ...
  return (
    <>
      <WebPageStructuredData
        ...
        url="/guides/where-to-read-manga-legally"
      ...
      <BreadcrumbStructuredData
        items={[
          ...
          { name: 'Where to read manga legally', item: '/guides/where-to-read-manga-legally' },
        ]}
      />
      <HowToStructuredData
