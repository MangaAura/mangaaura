...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      title: `${t('page.howItWorks.title')} | MangaAura`,
      description: t('page.howItWorks.description'),
      type: 'website',
      images: ['/og-image.png'],
    },
            ...
            <div className="mt-16 flex items-center justify-center">
              <div className="flex items-center justify-center gap-8 bg-[var(--surface-elevated)]/80 rounded-xl px-8 py-4">
                <div className="text-center">
                  ...
                  <div className="text-sm text-[var(--text-secondary)]">{t('page.howItWorks.statReaders')}</div>
                </div>
                ...
                <div className="text-center">
                  ...
                  <div className="text-sm text-[var(--text-secondary)]">{t('page.howItWorks.statSeries')}</div>
                </div>
                <div className="w-px h-12 bg-[var(--border)]" />
                <div className="text-center">
                  <div className="text-3xl font-bold text-[var(--text-primary)]">
                  ...
                  <div className="text-sm text-[var(--text-secondary)]">{t('page.howItWorks.statChapters')}</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <Container className="relative z-10">
          <div className="text-center mb-16">
            <span className="inline-flex items-center gap-2 text-sm font-medium text-[var(--primary)] mb-4">
              ...
              {t('page.howItWorks.sectionStepsBadge')}
            </span>
            <h2 className="text-4xl sm:text-5xl font-bold mb-4 text-[var(--text-primary)]">
              {t('page.howItWorks.sectionStepsTitle')}
            </h2>
            <p className="text-lg text-[var(--text-secondary)] max-w-2xl mx-auto">
              {t('page.howItWorks.sectionStepsSubtitle')}
            </p>
          </div>
            ...
            {[
              {
                ...
                title: t('page.howItWorks.step1Title'),
                desc: t('page.howItWorks.step1Desc'),
                accent: 'from-violet-500 to-purple-600',
              },
              {
                icon: <BookOpen className="w-8 h-8" />,
                title: t('page.howItWorks.step2Title'),
                desc: t('page.howItWorks.step2Desc'),
                accent: 'from-cyan-500 to-blue-600',
              },
              {
                icon: <Star className="w-8 h-8" />,
                title: t('page.howItWorks.step3Title'),
                desc: t('page.howItWorks.step3Desc'),
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <Container className="relative z-10">
          <div className="text-center mb-16">
            <span className="inline-flex items-center gap-2 text-sm font-medium text-[var(--primary)] mb-4">
              <Sparkles className="w-4 h-4" />
              {t('page.howItWorks.sectionFeaturesBadge')}
            </span>
            <h2 className="text-4xl sm:text-5xl font-bold mb-4 text-[var(--text-primary)]">
              {t('page.howItWorks.sectionFeaturesTitle')}
            </h2>
          </div>
            ...
            {[
              {
                ...
                title: t('page.howItWorks.featureReadTitle'),
                desc: t('page.howItWorks.featureReadDesc'),
                color: 'bg-violet-500/10 text-violet-500 border-violet-500/20',
              },
              {
                icon: <Sparkles className="w-6 h-6" />,
                title: t('page.howItWorks.featureCreateTitle'),
                desc: t('page.howItWorks.featureCreateDesc'),
                color: 'bg-pink-500/10 text-pink-500 border-pink-500/20',
              },
              {
                icon: <Coins className="w-6 h-6" />,
                title: t('page.howItWorks.featureCrowdfundTitle'),
                desc: t('page.howItWorks.featureCrowdfundDesc'),
                color: 'bg-amber-500/10 text-amber-500 border-amber-500/20',
              },
              {
                icon: <Trophy className="w-6 h-6" />,
                title: t('page.howItWorks.featureXpTitle'),
                desc: t('page.howItWorks.featureXpDesc'),
                color: 'bg-emerald-500/10 text-emerald-500 border-emerald-500/20',
              },
              {
                icon: <Smartphone className="w-6 h-6" />,
                title: t('page.howItWorks.featureOfflineTitle'),
                desc: t('page.howItWorks.featureOfflineDesc'),
                color: 'bg-cyan-500/10 text-cyan-500 border-cyan-500/20',
              },
              {
                icon: <Shield className="w-6 h-6" />,
                title: t('page.howItWorks.featureFreeTitle'),
                desc: t('page.howItWorks.featureFreeDesc'),
        ...
        <Container className="relative z-10">
          <div className="text-center mb-16">
            <span className="inline-flex items-center gap-2 text-sm font-medium text-[var(--primary)] mb-4">
              ...
              {t('page.howItWorks.sectionFaqBadge')}
            </span>
            <h2 className="text-4xl sm:text-5xl font-bold mb-4 text-[var(--text-primary)]">
              {t('page.howItWorks.sectionFaqTitle')}
            </h2>
            <p className="text-lg text-[var(--text-secondary)] max-w-2xl mx-auto">
              {t('page.howItWorks.sectionFaqSubtitle')}
            </p>
          </div>
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <Container>
          <div className="relative max-w-3xl mx-auto text-center">
            ...
            <h2 className="text-4xl sm:text-5xl font-bold mb-4 text-[var(--text-primary)]">
              {t('page.howItWorks.ctaTitle')}
            </h2>
            <p className="text-lg text-[var(--text-secondary)] mb-8">
              {t('page.howItWorks.ctaDescription')}
            </p>
            <div className="flex flex-wrap items-center justify-center gap-4">
              <Link
                href="/auth/register"
