...
import { Sparkles, Search, Hash, BookOpen, Eye, AlertTriangle, TrendingUp, Award, Clock, ArrowUp, Compass } from 'lucide-react';
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-10">
        ...
        >
          ...
          <Link href="/search-ai" aria-current="page" className="flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-bold bg-gradient-to-r from-[var(--primary)] to-[var(--accent-purple)] text-white shadow-sm shadow-[var(--primary)]/20">
            <Sparkles size={16} />
            {t('search.iaTitle')}
          </Link>
                  ...
                  <div className="group block">
                    ...
                    {manga.authorUsername ? (
                      <Link
                        ...
                        className="text-xs text-[var(--text-tertiary)] mt-1 truncate block hover:text-[var(--primary)] transition-colors"
                      >
                        {manga.authorName}
                      </Link>
                    ) : (
