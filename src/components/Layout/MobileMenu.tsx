...
export function MobileMenu({
  ...
  return (
    <div className="fixed inset-0 z-[60] md:hidden animate-ac-fade-in">
      ...
      <div
        className="absolute right-0 top-0 h-full w-full max-w-sm bg-[var(--surface)] shadow-2xl shadow-black/20 overflow-y-auto rounded-l-2xl animate-ac-slide-in-right"
