...
export function ProfileSocialLinks({ website, socialLinks }: ProfileSocialLinksProps) {
  ...
  const hasLinks = Object.values(parsedLinks).some(Boolean);

  if (!website && !hasLinks) return null;
