  ...
  return (
    <div className="min-h-screen bg-[var(--background)] flex items-center justify-center">
      <div className="bg-[var(--surface)] border border-[var(--border)] rounded-xl p-8 max-w-md w-full mx-4 text-center">
        ...
        <h1 className="text-2xl font-bold text-[var(--text-primary)] mb-2">{t('admin.errorPages.accessDeniedTitle')}</h1>
        <p className="text-[var(--text-secondary)] mb-6">{t('admin.errorPages.accessDeniedMessage')}</p>
      </div>
    </div>
  );
}
