/**
 * Seed de noticias (NewsArticle) para InkVerse
...
const staticArticles: ArticleSeed[] = [
  ...
  },
  {
    ...
    content:
      'We\'re excited to announce a major update to our AI creation tools. The new suite includes enhanced character generation with better consistency, improved background scene creation, and an advanced inpainting tool for fine-tuning your panels. Our AI now better understands manga art styles and can assist with screentone patterns, speed lines, and effect backgrounds. These tools are available to all creators on InkVerse. Upgrade your workflow and bring your stories to life!',
    category: 'platform',
    date: '2026-05-05',
    coverUrl:
